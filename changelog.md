...
* Blinker
  ...
  * Unobtainable (for now) as it's unfinished
...
* Increased torches from crafting recipes
  * Also added support for Endergetic Expansion
...
* Painful world border and discrete name tags gamerules names are now the same as other gamerules (e.g. `iguanatweaks:discrete_name_tags` -> `iguanatweaks:discreteNameTags`)
...
* Reduced Hang Glider durability
...
* Bows now accept luck enchantment
...
* Re-enabled villagers advancements
