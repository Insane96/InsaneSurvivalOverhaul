...
public class AttackSounds extends Feature {
    public static final RegistryObject<SoundEvent> PICKAXE_ATTACK = ISORegistries.SOUND_EVENTS.register("pickaxe_attack", () -> SoundEvent.createFixedRangeEvent(InsaneSO.location("pickaxe_attack"), 16f));
    public static final RegistryObject<SoundEvent> SHOVEL_ATTACK = ISORegistries.SOUND_EVENTS.register("shovel_attack", () -> SoundEvent.createFixedRangeEvent(InsaneSO.location("shovel_attack"), 16f));
