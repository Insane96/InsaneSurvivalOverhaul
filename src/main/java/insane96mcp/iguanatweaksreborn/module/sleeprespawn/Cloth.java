...
@LoadFeature(module = Modules.Ids.SLEEP_RESPAWN, description = "Zombies drop cloth instead of Rotten Flesh. Cloth is used to make beds and various other stuff.")
