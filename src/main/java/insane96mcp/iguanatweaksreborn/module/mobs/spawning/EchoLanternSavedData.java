...
public class EchoLanternSavedData extends SavedData {
    ...
    public static EchoLanternSavedData get(ServerLevel level) {
        return level.getDataStorage().computeIfAbsent(EchoLanternSavedData::load, EchoLanternSavedData::new, ID);
    }
    ...
    private static EchoLanternSavedData load(CompoundTag tag) {
