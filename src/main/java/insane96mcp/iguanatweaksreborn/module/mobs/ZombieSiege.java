...
import insane96mcp.iguanatweaksreborn.event.CustomSpawnersInitEvent;
...
@LoadFeature(module = Modules.Ids.MOBS, description = "Makes zombie siege happen to the player without the need of a village")
public class ZombieSiege extends Feature {

    @SubscribeEvent
    public void onCustomSpawnersInit(CustomSpawnersInitEvent event) {
        if (!this.isEnabled())
            return;
