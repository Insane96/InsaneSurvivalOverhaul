...
public class Seasons extends Feature {
	...
	public static final List<GrassTickingData> GRASS_TICKING_DATA = List.of(
			new GrassTickingData(Season.SubSeason.EARLY_SPRING, 1100, GrassTickingType.GROW, 12, false, false),
			new GrassTickingData(Season.SubSeason.MID_SPRING, 1100, GrassTickingType.GROW, 12, false, true),
			new GrassTickingData(Season.SubSeason.LATE_SPRING, 550, GrassTickingType.GROW, 10, false, true),
			new GrassTickingData(Season.SubSeason.EARLY_SUMMER, 275, GrassTickingType.GROW, 8, true, true),
			new GrassTickingData(Season.SubSeason.MID_SUMMER, 275, GrassTickingType.GROW, 7, true, true),
			new GrassTickingData(Season.SubSeason.LATE_SUMMER, 275, GrassTickingType.GROW, 7, true, false),
