package insane96mcp.insanesurvivaloverhaul.world.level.levelgen.structure.templatesystem;
...
public class RandomBlockTagMatchTest extends RuleTest {
    public static final MapCodec<RandomBlockTagMatchTest> CODEC = RecordCodecBuilder.mapCodec((p_259017_) -> p_259017_.group(
    ...
    public static class Type implements RuleTestType<RandomBlockTagMatchTest> {
        @Override
        public MapCodec<RandomBlockTagMatchTest> codec() {
            return CODEC;
        }
    }
}
