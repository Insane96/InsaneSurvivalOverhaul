...
public class DayNightCycle extends Feature {
    @Config(description = "How many minutes does a full day last? This DOESN'T CHANGE the day night cycle duration, but it's only used for calculations in case another mod changes it.")
