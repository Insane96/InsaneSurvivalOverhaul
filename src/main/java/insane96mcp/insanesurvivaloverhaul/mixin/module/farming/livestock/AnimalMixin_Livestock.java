...
public abstract class AnimalMixin_Livestock extends AgeableMob {
    ...
    private boolean insanesurvivaloverhaulcheckIfServerSideBeforeSendingHearts(boolean original) {
    ...
    private void insanesurvivaloverhaulsendLoveHeartsToClients(Level instance, ParticleOptions pParticleData, double pX, double pY, double pZ, double pXSpeed, double pYSpeed, double pZSpeed, Operation<Void> original) {
    ...
    private boolean insanesurvivaloverhaulallowSetLoveCauseAnyway(Object left, Object right, Operation<Boolean> original) {
